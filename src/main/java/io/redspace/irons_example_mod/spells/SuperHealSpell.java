...
public class SuperHealSpell extends AbstractSpell {
    ...
    @Override
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource source, MagicData playerMagicData) {
        entity.heal(getSpellPower(spellLevel, entity));
        super.onCast(world, spellLevel, entity, source, playerMagicData);
    }
