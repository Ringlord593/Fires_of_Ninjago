...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> EXAMPLE_MAGIC_SWORD = ITEMS.register("example_magic_sword", () -> new ExampleMagicSword( SpellDataRegistryHolder.of(new SpellDataRegistryHolder(ExampleSpellRegistry.SUPER_HEAL_SPELL, 1))));
}
